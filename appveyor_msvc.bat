...
msbuild INSTALL.vcxproj /m /clp:ErrorsOnly /p:Configuration=Release
...
msbuild INSTALL.vcxproj /clp:ErrorsOnly /p:Configuration=Release
...
cd cppunit/src
msbuild CppUnitLibraries2010.sln /m /clp:ErrorsOnly /p:Configuration=Release /p:Platform=%MSVC_PLATFORM% /p:PlatformToolset=%MSVC_PLATFORM_TOOLSET%
...
msbuild tulip.sln /m /p:Configuration=Release
msbuild runTests.vcxproj /p:Configuration=Release         
