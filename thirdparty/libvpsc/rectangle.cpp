 ...
 */
void removeRectangleOverlaps(Rectangles& rs) {
    const set<unsigned> fixed = set<unsigned>();
    removeRectangleOverlaps(rs,fixed);
}
 ...
 */
void removeRectangleOverlaps(Rectangles& rs, const set<unsigned>& fixed, bool thirdPass) {
