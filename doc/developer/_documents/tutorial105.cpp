 ...
 * g++ tutorial100.cpp `/home/talipot/Documents/talipot/talipot-install/bin/talipot-config --libs
...
int main(int argc, char **argv) {
  /*
  A QApplication must always be declared at the beginning of the main function in order for Talipot to
  work.
