...
The plugin management center can be found in the Talipot window, under the tab "Plugins center".

.. image:: _images/talipot-plugin_center.png
    :width: 600

As you can see, we are here again speaking of the framework and no more of the perspective. The plugins are added directly into Talipot so they can become available in every perspective in the framework. Please, also note that due to library specification and software portability, the Plugin center is not available on Unix-like systems and therefore can only be used on the Apple Mac OS and Microsoft Windows operating systems.
...
.. |icon_algorithm| image:: ../../software/talipot/resources/icons/64/plugin_algorithm.png
.. |icon_import_export| image:: ../../software/talipot/resources/icons/64/plugin_import_export.png
.. |icon_glyph| image:: ../../software/talipot/resources/icons/64/plugin_glyph.png
.. |icon_view| image:: ../../software/talipot/resources/icons/64/plugin_view.png
.. |icon_interactor| image:: ../../software/talipot/resources/icons/64/plugin_interactor.png
.. |icon_perspective| image:: ../../software/talipot/resources/icons/64/plugin_controller.png
...
* |icon_view| **Views**: the node link diagram and the spreadsheet are not the only available views in Talipot. For instance, the parallel coordinates, pixel oriented and scatter plot 2D views can be used for analyzing the correlations between properties. The view defined how you visualize the information.
...
* |icon_perspective| **Perspectives**: Talipot may have different uses. Perspectives can be developed for a specific domain such as social network analysis or an advanced customization of the provided features for specific tasks such as web sites links analysis.
...
.. image:: _images/talipot-plugin_install.png
    :width: 600

Once clicked on, a message indicating the need to restart Talipot to apply the changes appears.

After relaunching the software, the plugin, here the algorithm, will be available

.. image:: _images/talipot-plugin_apply.png
    :width: 600
