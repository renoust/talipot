...
#ifndef PERSPECTIVE_PROCESS_HANDLER_H
#define PERSPECTIVE_PROCESS_HANDLER_H
...
class PerspectiveProcessHandler : public QTcpServer {
  Q_OBJECT

  QMap<QProcess *, PerspectiveProcessInfo> _processInfo;

  static PerspectiveProcessHandler *_instance;
  PerspectiveProcessHandler();
...
public:
  static PerspectiveProcessHandler *instance();
...
#endif // PERSPECTIVE_PROCESS_HANDLER_H
