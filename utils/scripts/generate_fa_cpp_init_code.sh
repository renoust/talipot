...
# library/talipot-ogl/src/InitFontAwesome.cpp
# The files fa-[brands-400|regular-400|solid-900].[ttf|woff|woff2] from
# the webfonts sub directory must be copied in library/talipot-ogl/bitmaps
...
(echo "// Warning: do not update this file !!!";
 ...
 echo;
 echo "std::string FontAwesome::getVersion() {"
 ...
 echo;
 echo "#error fa-regular-400.ttf needs to be patched because the defined font has the same name that the one in fa-solid-900.ttf (see library/talipot-ogl/src/FontAwesome.cpp)"
 echo;
 echo "  clearFtFaces();";
 echo;
