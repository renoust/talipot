  ...
  IF(NOT CLANG OR CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 3.7.0 OR CMAKE_CXX_COMPILER_VERSION VERSION_EQUAL 3.7.0)
    ...
    IF(TULIP_ENABLE_MULTI_THREADING)
      ...
      IF(NOT TULIP_CXX_THREADS)
        ...
        IF(APPLE AND CLANG)
          STRING(COMPARE NOTEQUAL "${CMAKE_CXX_COMPILER_ID}" "AppleClang" LLVM_CLANG)
          IF(LLVM_CLANG)
            ...
            SET(CMAKE_C_FLAGS "-DLLVM_CLANG -I${LLVM_COMPILER_DIR}/../include ${CMAKE_C_FLAGS}" CACHE STRING "" FORCE)
            SET(CMAKE_CXX_FLAGS "-DLLVM_CLANG -I${LLVM_COMPILER_DIR}/../include ${CMAKE_CXX_FLAGS}" CACHE STRING "" FORCE)
