...
#ifndef TALIPOT_FOR_EACH_H
#define TALIPOT_FOR_EACH_H
...
namespace tlp {
/**
 * @brief Encapsulation of a Talipot Iterator intended to be allocated on the stack instead of the
 *heap,
 ...
 * It also avoid having to manage a talipot Iterator, whose deletion is often forgotten.
 *
