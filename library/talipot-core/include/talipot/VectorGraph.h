...
#ifndef TALIPOT_VECTOR_GRAPH_H
#define TALIPOT_VECTOR_GRAPH_H
 ...
 *
 * User can both use talipot iterators or direct vector to access to the graph structure for better
 * performance.
...
public:
   ...
   * \warning code that use that function won't be compatible with Talipot Graph API
   *
   * @remark o(1)
   * \see getInOutNodes
   * \see getInNodes
