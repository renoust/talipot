...
# in the main Talipot GUI. As the treemap layout is different from classical
# node link diagram representation, some visual properties setup has to be
# done in order to get an aesthetic visualization of it in the main Talipot GUI.
...
to get an aesthetic visualization of it in Talipot.
